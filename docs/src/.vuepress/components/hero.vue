...
export default {
    mounted() {
    const $bashpound = document.getElementById('bashpound')
...
const L1 = new THREE.PointLight( 0x009696, 1);
L1.position.z = 100;
L1.position.y = 100;
L1.position.x = 100;
scene.add(L1);

const L2 = new THREE.PointLight( 0x006eff, 0.9)
L2.position.z = 200;
L2.position.y = 100;
L2.position.x = -100;
scene.add(L2);
